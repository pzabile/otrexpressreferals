...
?>
<section class="wrap section thanks">
  <p class="eyebrow">Referral Received</p>
  <h1>You're in the queue.</h1>
  <p class="lead narrow">
    Thanks<?= $referral ? ', ' . e((string)$referral['referrer_name']) : '' ?>.
    Your referral has been sent to the OTR Express Group admin team. Check
    back anytime to see where
    <?= $referral ? e((string)$referral['driver_name']) : 'your driver' ?>
    is in the pipeline.
  </p>
  <div class="cta-row center">
    <a class="btn-primary" href="/status">Check Referral Status</a>
    <a class="btn-ghost" href="/refer">Refer Another Driver</a>
  </div>
</section>
